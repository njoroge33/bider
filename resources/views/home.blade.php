...
<div class="card card-style shadow-xl">        
        ...
        <div class="task-slider owl-carousel owl-no-dots">
        ...
        <div class="row mr-0 ml-0 item1">
        @foreach ($auctions as $auction)
            @if ($auction->category == "phones"); 
        ...
        <div class="row mr-0 ml-0 item2" style="display:none;">
        @foreach ($auctions as $auction)
            @if ($auction->category == "electronics")
            <div class="col-4 card">
                <img src="{{ url('uploads/'.$auction->image) }}" class="img-fluid rounded-sm mb-3">
                <p class="mb-n1 color-orange-light font-600 p-0">{{$auction->name}}</p>
                <!-- <h1>1 of 3</h1>
        ...
        <div class="row mr-0 ml-0 item3" style="display:none;">
        @foreach ($auctions as $auction)
        @if ($auction->category == "computers")
            <div class="col-4 card">
                <img src="{{ url('uploads/'.$auction->image) }}" class="img-fluid rounded-sm mb-3">
                <p class="mb-n1 color-orange-light font-600 p-0">{{$auction->name}}</p>
                <!-- <h1>1 of 3</h1>
